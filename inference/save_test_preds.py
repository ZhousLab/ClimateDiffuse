...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelname", type=str, default="Diffusion")    # "Diffusion" or "UNet" or "LinearInterpolation"
    parser.add_argument("--year_start", type=int, default=2020)
    parser.add_argument("--year_end", type=int, default=2021)
    parser.add_argument("--data_dir", type=str, default="/home/git/ClimateDiffuse/data_sample")
    parser.add_argument("--model_path", type=str, default="/home/git/ClimateDiffuse/Model/diffusion.pt")
    parser.add_argument("--save_dir", type=str, default="/home/git/ClimateDiffuse/output")
